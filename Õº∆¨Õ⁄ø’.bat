...
if not exist %java_home%  set java_home=%~dp0../jre18031
...
%javaexec%  -classpath ".;.\classes;%~dp0bin;%prj_home%\bin;%prj_home%WEB-INF\classes;%~dp0lib_lazy\atiplat_core.jar;%~dp0lib_lazy\opencv-2413.jar" -Djava.ext.dirs="%~dp0lib;%prj_home%\lib;%prj_home%WEB-INF\lib;%prj_home%lib_jetty9"   -Djava.library.path="%~dp0dll;%prj_home%\dll"  aa.findColorAreasCls
pause