...
public class CEntityForm extends JFrame {
  ...
  public CEntityForm() {
   jButtonStep1.addActionListener(new java.awt.event.ActionListener() {
	...
	m_bimage1=ImageIO.read(new File(f)) ;
    m_panel1.setBufferedImage(m_bimage1);
    //Send image for skeletinization
    System.out.println(" setFingerPrintImage ok a:"+f );
    m_finger1.setFingerPrintImage(m_bimage1) ;
    System.out.println(" setFingerPrintImage ok:"+f );
    finger1=m_finger1.getFingerPrintTemplate();
     //See what skeletinized image looks like
    // BufferedImage  m_bimage1
    m_bimage1 = m_finger1.getFingerPrintImageDetail();
    imgx.save_overwrite(m_bimage1, "D:\\0workspace\\atiplat_img\\figerprint\\images\\candidate1_getFingerPrintImageDetail.jpg");
    m_panel1.setBufferedImage(m_bimage1);
  ...
  //  m_bimage2=ImageIO.read(new File(new java.io.File("").getAbsolutePath()+"\\ProcessedSample2.bmp")) ;
	...
	m_bimage2=ImageIO.read(new File( f2 )) ;
    m_panel2.setBufferedImage(m_bimage2);
    //Send image for skeletinization
    m_finger2.setFingerPrintImage(m_bimage2) ;
    System.out.println(" setFingerPrintImage ok:"+f2 );
    finger2=m_finger2.getFingerPrintTemplate();
    //See what skeletinized image looks like
    m_bimage2 = m_finger2.getFingerPrintImageDetail();
    imgx.save_overwrite(m_bimage1, "D:\\0workspace\\atiplat_img\\figerprint\\images\\candidate2_getFingerPrintImageDetail.jpg");
...
//      {
        try {
			String f = "d:/home/scott/JavaBiometrics/FingerPrintPic/Sample2.bmp";
			f=Path.Combine("D:\\0workspace\\atiplat_img\\figerprint\\images", "probe.jpg");
			filex.createAllPath(f);
			m_bimage2=ImageIO.read(new File(f)) ;
